...
public class s_password extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_s_password);
        ...
        TextView t2 = (EditText) findViewById(R.id.oldpass);
        TextView t3 = (EditText) findViewById(R.id.newpass);
    ...
    public void savedata(View view) {
        ...
        if (oldpass != pass){
            ...
            messeger.setText("تم تفيير كلمة السر بنجاح");
